    ...
    {tasks.length === 0 ? (
      ...
      <ul className="space-y-3">
        {tasks.map((t, index) => (
          <li
            key={index}
            className="bg-white/15 border border-white/20 backdrop-blur-md rounded-2xl px-4 py-3 text-white shadow-md hover:bg-white/20 hover:translate-x-1 transition duration-200"
          >
            ✨ {t}
          </li>
        ))}
